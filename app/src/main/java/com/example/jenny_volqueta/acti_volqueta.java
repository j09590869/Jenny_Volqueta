...
public class acti_volqueta extends AppCompatActivity implements Asynchtask {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_acti_volqueta);
        ...
        WebService ws= new WebService(
                ...
                datos, acti_volqueta.this, acti_volqueta.this);
        ws.execute("GET");
    }
